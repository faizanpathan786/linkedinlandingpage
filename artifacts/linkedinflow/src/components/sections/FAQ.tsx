            ...
            return (
              <motion.div
                ...
                className={`rounded-xl border transition-colors duration-200
                  ${isOpen
                    ? "border-[#8acb4f]/25 bg-[linear-gradient(160deg,rgba(138,203,79,0.06)_0%,rgba(255,255,255,0.02)_100%)]"
              ...
              >
                ...
                >
                  <span className={`shrink-0 text-xs font-mono font-bold tabular-nums transition-colors duration-200 ${isOpen ? "text-[#8acb4f]" : "text-[#3d4449]"}`}>
                  ...
                  <span className={`shrink-0 w-6 h-6 rounded-full flex items-center justify-center transition-colors duration-200 ${isOpen ? "bg-[#8acb4f]/20 text-[#8acb4f]" : "bg-white/[0.06] text-[#555d64]"}`}>
