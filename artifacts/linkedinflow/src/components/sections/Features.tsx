...
const FEATURES = [
  {
    icon: <Sparkles className="w-5 h-5 text-[#8acb4f]" />,
  ...
  {
    icon: <Layers className="w-5 h-5 text-[#8acb4f]" />,
  ...
  {
    icon: <Lock className="w-5 h-5 text-[#8acb4f]" />,
  ...
  return (
    ...
    <div style={{ perspective: "900px" }} onMouseEnter={onActivate}>
      ...
      >
        ...
        <motion.div
          className="absolute -top-12 -right-12 w-32 h-32 rounded-full bg-[#8acb4f]/12 blur-3xl pointer-events-none"
        ...
        <motion.div
          className="mb-5 flex h-12 w-12 items-center justify-center rounded-xl
                     border border-[#8acb4f]/25 bg-[#8acb4f]/10 shrink-0"
          animate={
        ...
        <motion.div
          className="mt-5 h-px rounded-full bg-gradient-to-r from-[#8acb4f] to-[#c8f570]"
          animate={{
...
export function Features() {
  ...
  return (
    <section id="features" className="relative overflow-hidden py-24 px-4 bg-background">
      ...
      <motion.div
        aria-hidden="true"
        className="pointer-events-none absolute -left-24 top-24 h-64 w-64 rounded-full bg-[#8acb4f]/8 blur-3xl"
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <motion.div
            className="mx-auto mb-5 h-px w-24 bg-gradient-to-r from-transparent via-[#8acb4f] to-transparent"
            animate={{ opacity: [0.4, 1, 0.4], scaleX: [0.85, 1.1, 0.85] }}
            transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
          />
          <p className="text-xs font-semibold uppercase tracking-[0.24em] text-[#8acb4f] mb-4">
            Features
          </p>
