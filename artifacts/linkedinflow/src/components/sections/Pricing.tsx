    ...
    <section id="pricing" className="py-28 px-4 bg-[#060810] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-14">
          <motion.p className="text-xs font-semibold uppercase tracking-[0.22em] text-[#8acb4f] mb-3"
          ...
          >
            ...
            <button
              ...
              className={`relative w-11 h-6 rounded-full transition-colors duration-250 focus:outline-none ${isYearly ? "bg-[#8acb4f]" : "bg-white/10"}`}
            ...
            <span className={`text-sm font-medium flex items-center gap-2 transition-colors duration-200 ${isYearly ? "text-white" : "text-[#555d64]"}`}>
              Yearly
              <span className="bg-[#8acb4f]/15 text-[#8acb4f] text-xs px-2 py-0.5 rounded-full font-semibold border border-[#8acb4f]/20">Save 20%</span>
            </span>
          </motion.div>
        </div>
          ...
          {plans.map((plan, i) => (
            <motion.div
              ...
              className={`relative flex flex-col rounded-2xl overflow-hidden
                ${plan.popular
                  ? "border-2 border-[#8acb4f]/50 bg-[linear-gradient(160deg,rgba(138,203,79,0.08)_0%,rgba(255,255,255,0.03)_100%)] shadow-[0_0_50px_rgba(138,203,79,0.18)] scale-[1.03]"
                  : "border border-white/[0.07] bg-[linear-gradient(160deg,rgba(255,255,255,0.04)_0%,rgba(255,255,255,0.02)_100%)]"}`}
            >
              <div className={`absolute inset-x-0 top-0 h-px ${plan.popular ? "bg-gradient-to-r from-transparent via-[#8acb4f]/60 to-transparent" : "bg-gradient-to-r from-transparent via-white/10 to-transparent"}`} />

              {plan.popular && (
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center gap-1.5 bg-[#8acb4f] text-[#111415] text-xs font-bold px-3 py-1 rounded-full shadow-[0_0_20px_rgba(138,203,79,0.5)]">
              ...
              <div className="p-7 flex flex-col flex-1">
                ...
                <a href="https://linkedinflowfe.vercel.app" target="_blank" rel="noopener noreferrer" className="mb-7">
                  <Button className={`w-full font-semibold transition-all duration-200
                    ${plan.popular
                      ? "bg-[#8acb4f] text-[#111415] hover:bg-[#a0d95e] border-0 shadow-[0_0_22px_rgba(138,203,79,0.3)] hover:shadow-[0_0_32px_rgba(138,203,79,0.5)]"
                ...
                <ul className="space-y-3.5 mt-auto">
                  {plan.features.map((f, j) => (
                    ...
                    >
                      <span className={`mt-0.5 w-4 h-4 rounded-full flex items-center justify-center shrink-0 ${plan.popular ? "bg-[#8acb4f]/20" : "bg-white/[0.06]"}`}>
                        <Check className={`w-2.5 h-2.5 ${plan.popular ? "text-[#8acb4f]" : "text-[#6a7177]"}`} />
                      </span>
